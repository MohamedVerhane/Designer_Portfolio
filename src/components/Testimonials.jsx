...
const testimonials = [
  {
    ...
    text: "Meridian Studio completely transformed how our users interact with our platform. The redesign increased our daily active users by 40% in the first quarter alone. Their ability to balance business goals with user needs is unmatched.",
  ...
  },
  {
    ...
    text: "Working with Meridian felt like having a senior design team embedded in our company. They didn't just deliver a brand \u2014 they gave us an identity that resonates with our users on a deeper level. Revenue grew 60% within six months of launch.",
