  ...
  return (
    ...
    >
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-1/2 -right-1/4 w-[800px] h-[800px] rounded-full bg-accent-100/40 blur-[120px]" />
        <div className="absolute -bottom-1/3 -left-1/4 w-[600px] h-[600px] rounded-full bg-accent-50/60 blur-[100px]" />
      </div>
      ...
      <div className="relative mx-auto max-w-7xl px-5 sm:px-8 lg:px-12 pt-32 pb-20 lg:pt-40 lg:pb-28 w-full">
        ...
        >
          <motion.div variants={item} className="mb-6">
            <span className="inline-flex items-center gap-2 rounded-full border border-accent-200 bg-accent-50 px-4 py-1.5 text-xs font-medium tracking-wide text-accent-700 uppercase">
          ...
          <motion.h1
            variants={item}
            className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold tracking-tight text-dark leading-[1.1]"
          >
            We craft digital
            <br />
            experiences that
          ...
          <motion.div variants={item} className="mt-10 flex flex-wrap items-center gap-4">
            <a
              ...
              className="group inline-flex items-center gap-2.5 rounded-full bg-dark px-7 py-3.5 text-sm font-medium text-white transition-all duration-300 hover:bg-accent-600 hover:shadow-xl hover:shadow-accent-600/25 active:scale-[0.97]"
            >
            ...
            <a
              ...
              className="group inline-flex items-center gap-2 rounded-full border border-stone-200 bg-white px-7 py-3.5 text-sm font-medium text-dark transition-all duration-300 hover:border-stone-300 hover:shadow-md active:scale-[0.97]"
            >
              View Our Work
        ...
        >
          <div className="relative">
            <div className="aspect-[4/5] rounded-3xl overflow-hidden shadow-2xl shadow-dark/10 ring-1 ring-stone-900/5">
              <ImageWithFallback
            ...
            <motion.div
              ...
              className="absolute -bottom-4 left-4 sm:-left-6 bg-white rounded-xl shadow-lg shadow-dark/8 p-3 flex items-center gap-3 ring-1 ring-stone-900/5"
            >
            ...
            <motion.div
              ...
              className="absolute top-1/3 left-2 sm:-left-10 bg-white rounded-xl shadow-lg shadow-dark/8 p-3 ring-1 ring-stone-900/5 hidden xl:flex items-center gap-3"
            >
